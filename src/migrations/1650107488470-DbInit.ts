...
export class DbInit1650107488470 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "CARBON_CERTIFICATES" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "country" character varying NOT NULL, "status" "public"."CARBON_CERTIFICATES_status_enum" NOT NULL DEFAULT 'available', "owner" uuid, CONSTRAINT "PK_801460b4eebc9362799daf4b73c" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
